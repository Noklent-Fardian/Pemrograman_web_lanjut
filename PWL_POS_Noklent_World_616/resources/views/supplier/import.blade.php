        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('excel/template_supplier.xlsx') }}" class="btn btn-info btn-sm" download>
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 pl-4 mt-1">
                        <li><strong>Kolom A:</strong> Kode Supplier (max 10 karakter)</li>
                        <li><strong>Kolom B:</strong> Nama Supplier (max 100 karakter)</li>
                        <li><strong>Kolom C:</strong> Alamat (max 255 karakter)</li>
                        <li><strong>Kolom D:</strong> Kontak (max 15 karakter)</li>
                        <li><strong>Kolom E:</strong> Email (opsional)</li>
                        <li><strong>Kolom F:</strong> Status Aktif (0 atau 1)</li>
                        <li><strong>Kolom G:</strong> Keterangan</li>
                    </ul>
                </div>
                <div class="form-group">
