        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('excel/template_barang.xlsx') }}" class="btn btn-info btn-sm" download><i
        ...
        $("#form-import").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    processData: false, // setting processData dan contentType ke false, untuk mengwdw file
                    contentType: false,
                    success: function(response) {
                        if (response.status) { // jika sukses 
                            ...
                            setTimeout(function() {
                                window.location.reload(); // reload halaman tidak dengan syntax datatable.ajax.reload();
                            }, 1000); // delay 1 detik
                        } else { // jika error 
