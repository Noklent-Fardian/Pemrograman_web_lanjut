...
|
*/
Route::pattern('id', '[0-9]+'); //artinya ketika ada parameter id yang diisi dengan angka
route::get('login', [AuthController::class, 'login'])->name('login');
Route::post('login', [AuthController::class, 'postLogin'])->name('postLogin');
Route::get('logout', [AuthController::class, 'logout'])->name('logout')->middleware('auth'); //route untuk logout

Route::middleware(['auth'])->group(function () { //middleware auth digunakan untuk mengamankan route yang ada di dalamnya atau harus login ter;lebih dahulu
